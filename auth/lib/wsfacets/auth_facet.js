...
var Accounts, DropReason, Log, WSMessageHelper;
...
module.exports.processMessage = function(connection, message, next) {
  ...
  try {
    ...
    try {
      ...
      throw dropError(DropReason.CLOSE_REASON_INVALID_DATA, "Bad message format", "Bad message format: \r\client_id: " + connection._tern.client_id + "\r\nrequest: " + textMessage);
    }
    if (!request) {
